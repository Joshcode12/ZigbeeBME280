...
#define BME280_REG_HUM_LSB 0xFD
#define BME280_REG_HUM_MSB 0xFE
...
/**
 * @brief  Read the temperature, pressure, and humidity and apply the
 * compensation to them
 * @param  handle: Handle for the BME280 sensor
